...
public class AppTest {
    ...
    public void testAngleTo() {
        System.out.println(String.format("(%f,%f)", appletonTower.longitude, appletonTower.latitude));

        // ~100
        System.out.println(appletonTower.angleTo(greyfriarsKirkyard));
        System.out.println();
        // ~260
        System.out.println(appletonTower.angleTo(businessSchool));
        assertTrue(true);
    }
